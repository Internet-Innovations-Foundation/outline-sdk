...
- (NSString* _Nonnull)getTLSTransportStrategy;
/**
...
Uses format [scheme]://[host]:[port] in case of ss/ws/socks5/wg
otherwise uses String() method of the configurl.
 */
- (void)setTLSTransportStrategy:(NSString* _Nullable)tlsConfig;
@end
...
@property (nonatomic) NSString* _Nonnull transportConfig;
